...
function CalcScore(){
    ...
    if (total_score >= 50){ //If total score is more that 50, add new category to list of available quizzes.
        the_great_quiz.quizzes = [this.computer_commando, this.literature, this.language];
    }
}
...
while (choice != 0){
    ...
    if (choice === 0){
        ...
        if (history.length > 0){
            console.log(`${50-total_score} points left before unlocking bonus quiz`)
        }
        else{
